...
let
  ...
  release = "beta";
  version = "${majorVersion}.${minorVersion}.${maintenanceVersion}-${release}";
in

stdenv.mkDerivation rec {
  pname = "julia";
  # inherit version;
  rev = "ee07b8cb23e5330d25d0b05accdc0278997a0b3f";
  name = "${pname}-${rev}";

  # src = fetchzip {
  #   url = "https://github.com/JuliaLang/${pname}/releases/download/v${version}/${name}.tar.gz";
  #   sha256 = "1ckvlwjk3v5k8skcpgaff7a8nw4i9h796lggh184irsaiw1mg9cq";
  # };
  src = fetchgit {
    url = "https://github.com/JuliaLang/${pname}";
    inherit rev;
    sha256 = "0vy50ynk698sskn46lv887zc6dl3sf4wxn7jalw43p6gngqj001f";
  };
  ...
  patches = [
    ...
    ./0001-Use-system-suitesparse.patch
